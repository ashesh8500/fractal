...
try:
    ...
    class Settings:
        ...
        alphavantage_api_key: Optional[str] = os.getenv("PORTFOLIO_LIB_ALPHAVANTAGE_API_KEY")
        default_data_provider: str = "yfinance"
        log_level: str = "INFO"
...
def get_data_service(provider: Optional[str] = None):
    ...
    """
    from .services.data import YFinanceDataService, AlphaVantageDataService
...
if __name__ == "__main__":
    ...
    print(f"  - AlphaVantage API Key Loaded: {'Yes' if settings.alphavantage_api_key else 'No'}")
